...
def load_split(dataset: str, split: str) -> list[Example]:
    ...
    if d == "clinc150":
        ...
        local_path = Path("data/raw/clinc150/data_full.json")
        if local_path.exists():
            from .local_loaders import load_clinc150_local
            return load_clinc150_local(local_path, "train" if split == "train" else "test")
